...
description: "Use this skill at the start of any engagement to fingerprint a target's technology stack — frontend framework, backend language/framework, infra (CDN/WAF/cloud), security stack, identity provider, third-party correlations. Triggers: new target with unknown stack, before loading tech-specific hunt-* skills, or when /techstack command is invoked. Routes to 6 domain sub-skills. Only invoke this skill if there is real impact potential. Skip theoretical findings."
---
