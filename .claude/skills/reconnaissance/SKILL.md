---
name: reconnaissance
description: "Use this skill at the start of any external engagement when you need to map the attack surface — subdomain discovery, port scanning, endpoint enumeration, API discovery. Triggers: new target with only a root domain, /recon command, scope.md with wildcard domain, or whenever Phase 2 of the bug-bounty methodology begins. Generic recon — use specialized hunt-* skills once tech stack is identified. Only invoke this skill if there is real impact potential. Skip theoretical findings."
---
