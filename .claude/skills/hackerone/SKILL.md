---
name: hackerone
description: "Use this skill when the user provides a HackerOne scope CSV, when starting a HackerOne program engagement, when generating platform-ready submission reports, or whenever asked to parse h1 scope, deploy parallel hunters per asset, validate PoCs, or format reports to HackerOne markdown conventions. Triggers on hackerone.com URLs, scope.csv files, or program-name mentions. Only invoke this skill if there is real impact potential. Skip theoretical findings."
---
