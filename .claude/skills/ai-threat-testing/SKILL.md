...
description: "Use this skill when you encounter LLM-backed endpoints, AI chatbots, RAG systems, agentic copilots, or any feature that processes user prompts/documents through an AI model. Triggers: /chat, /assistant, /completion, /generate URL paths; OpenAI/Anthropic/Cohere headers in responses; \"Powered by GPT/Claude\" UI text; scope mentions LLM/AI features. Covers OWASP LLM Top 10 — prompt injection, model extraction, data poisoning, supply-chain attacks. Only invoke this skill if there is real impact potential. Skip theoretical findings."
---
