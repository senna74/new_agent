...
description: "Security-focused source code review and SAST. Scans for vulnerabilities (OWASP Top 10, CWE Top 25), CVEs in third-party dependencies/packages, hardcoded secrets, malicious code, and insecure patterns. Use when given source code, a repo path, or asked to \"audit\", \"scan\", \"review\" code security, or \"check dependencies for CVEs\". Only invoke this skill if there is real impact potential. Skip theoretical findings."
---
